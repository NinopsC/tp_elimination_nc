...
- a time curve (axis 1: organization of the data according to the timing before/during/after elimination)
- a separation of the "elimination" samples from the others (axis 2)
- a close proximity between the duplicates.
...
#### Analyse 3 : comparaison de l'expression différentielle entre 2 autres stades consécutifs VS le reste
