...
We're looking for genes with a significative up-regulation during genome elimination.
...
To search by protein domains keywords in our genes subset:
...
#### Analysis 2 : down-regulated genes (done by Quentin)
